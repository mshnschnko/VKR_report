...
\newcommand{\thesisSpecialtyCode}{5030102/00201}% код направления подготовки
...
%%
%%
\newcommand{\keywordsRu}{Автофокусировка, Электронная микроскопия, Свёрточные нейронные сети, Архитектура сети} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{Autofocus, Electron microscopy, Convolutional neural networks, Network architecture} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
